...
def main():
    ...
    parser.add_argument('--in-path', type=str, required=True, help='image folder path to test')
    parser.add_argument('--out-path', type=str, default='inference_results', help='mask image folder to save')
    parser.add_argument('--backbone', type=str, default='resnet',
                        choices=['resnet'],
                        help='backbone name (default: resnet)')
    parser.add_argument('--ckpt', type=str, default='modeling/deeplab-resnet.pth.tar',
                        help='saved model')
